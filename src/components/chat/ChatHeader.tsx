...
export default function ChatHeader({
  ...
  return (
    <Box className="bg-linear-to-r from-emerald-600 via-green-400 to-teal-500 text-white px-5 py-4 shadow-md">
        ...
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            {open && startChat && (
              <span className="absolute bottom-0 right-0 flex h-3 w-3">
                ...
                <span className="relative inline-flex rounded-full h-ful w-full bg-green-400 border-2 border-white"></span>
              </span>
            )}
          </div>
          ...
          <div>
            ...
            <Typography fontSize={12} className="opacity-90">
              {open && startChat && `${onlineUsers} users online`}
            </Typography>
          </div>
        </div>
